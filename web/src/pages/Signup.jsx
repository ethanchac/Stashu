    ...
    <div className="min-h-screen flex items-center justify-center bg-discord-darker px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-discord-text mb-2">
            Create an account
          </h1>
          <p className="text-discord-muted">
            Get started with your personal storage
          </p>
        </div>
        ...
        <div className="relative">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-discord-gray"></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-discord-darker text-discord-muted">
              Or continue with
            </span>
          </div>
        </div>
